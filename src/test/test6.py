...
Uq = torch.arange(u_min, u_max + etau, etau)
...
def min_max_range_cal(X_range_list, c_list, Lambda_list, etax):
    ...
    for i in range(len(c_list)):
        ...
        if Xq2_max < Xq2_max_tmp:
            ...
            Xq2_max = Xq0_max_tmp_round

    Xq_range_list = [[Xq0_min, Xq0_max], [Xq1_min, Xq1_max], [Xq2_min, Xq2_max]]
    return Xq_range_list

Xq_range_list = min_max_range_cal(X_range_list, c_list, Lambdax_list, etax)
Xqin_range_list = min_max_range_cal(X_range_list, cqin_list, Lambdax_list, etax)
print(Xq_range_list)
...
# np.save('./Q_np2.npy', Q_np)
# Q = torch.from_numpy(np.load('./Q_np2.npy'))
...
#                     if ind0_min < 0 or ind1_min < 0 or ind2_min < 0 or ind0_max > Q.shape[0] or ind1_max > Q.shape[1] or ind2_max > Q.shape[2]:
#                         continue
#                     else:
#                         ind_flag = 1
...
#                                     if Q[ind0_min + ind0][ind1_min + ind1][ind2_min + ind2] == 0:
#                                         ind_flag = 0
#                                         break
#                                 if ind_flag == 0:
#                                     break
