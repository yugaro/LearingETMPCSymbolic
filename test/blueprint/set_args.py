...
def set_args():
    ...
    parser.add_argument("--v_r", type=float, default=0.25)
    parser.add_argument("--omega_r", type=float, default=0.25)
    parser.add_argument("--v_max", type=float, default=3.0)
    parser.add_argument("--omega_max", type=float, default=3.25)
    parser.add_argument("--Kx", type=float, default=5)
    parser.add_argument("--Ky", type=float, default=5)
