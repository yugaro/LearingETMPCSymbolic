...
def set_args():
    ...
    parser.add_argument("--v_max", type=float, default=2.5)
    parser.add_argument("--omega_max", type=float, default=3.2)
    ...
    parser.add_argument("--gamma_params", type=float, default=400)
