...
print(mpc.opt_x_num['_x', 1, 0, 0])
print(mpc.opt_x_num['_x', 2, 0, 0])
print(mpc.opt_x_num['_x', 3, 0, 0])
print(mpc.opt_x_num['_x', 4, 0, 0])
print(mpc.opt_x_num['_x', 5, 0, 0])
print(mpc.opt_x_num['_x', 6, 0, 0])
print(mpc.opt_x_num['_x', 7, 0, 0])
print(mpc.opt_x_num['_u', 0, 0])
print(mpc.opt_x_num['_u', 1, 0])
print(mpc.opt_x_num['_u', 2, 0])
print(mpc.opt_x_num['_u', 3, 0])
print(mpc.opt_x_num['_u', 4, 0])
print(mpc.opt_x_num['_u', 5, 0])
print(mpc.opt_x_num['_u', 6, 0])
...
C0 = torch.sqrt(2 * torch.log((2 * (alpha0x**2)) / (2 * (alpha0x**2) - (gamma0**2))))
C1 = torch.sqrt(2 * torch.log((2 * (alpha1x**2)) / (2 * (alpha1x**2) - (gamma1**2))))
C2 = torch.sqrt(2 * torch.log((2 * (alpha2x**2)) / (2 * (alpha2x**2) - (gamma2**2))))
